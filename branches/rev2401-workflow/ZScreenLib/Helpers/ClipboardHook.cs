...
namespace ZScreenLib
{
    ...
    public class ClipboardHook : IDisposable
    {
        ...
        public static IntPtr mClipboardViewerNext;
        IntPtr mHandle;

        public ClipboardHook(IntPtr handle)
        {
            this.mHandle = handle;
        }
        ...
        public static int SendMessage(int wMsg, IntPtr wParam, IntPtr lParam)
        {
            ...
            {
                Engine.MyLogger.WriteException(ex, "Error in ClipboardHook.SendMessage");
                return -1;
            }
        }
        ...
        internal void RegisterClipboardViewer()
        {
            ...
            {
                mClipboardViewerNext = SetClipboardViewer(mHandle);
            }
        }
