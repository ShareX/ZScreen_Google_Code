...
#define ExePath "ZUploader\bin\Debug\ZUploader.exe"
...
[Files]
Source: ZUploader\bin\Debug\*.exe; Excludes: *.vshost.exe; DestDir: {app}; Flags: ignoreversion
Source: ZUploader\bin\Debug\*.dll; DestDir: {app}; Flags: ignoreversion
Source: ZUploader\bin\Debug\*.pdb; DestDir: {app}; Flags: ignoreversion
Source: ZUploader\bin\Debug\*.wav; DestDir: {app}; Flags: ignoreversion
