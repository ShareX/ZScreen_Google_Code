...
namespace DavuxLib.Controls
{
    ...
    public class TextBoxEx : System.Windows.Forms.TextBox
    {
        ...
        private bool _UseTabAsKey = false;
        ...
        {
            if (keyData == Keys.Tab && _UseTabAsKey)
            {
        ...
        [EditorBrowsable(EditorBrowsableState.Always)]
        [Category("Behavior")]
        [Description("Send Tab Key events to KeyDown")]
        public bool CustomTabAction
        {
            get { return _UseTabAsKey; }
            set { _UseTabAsKey = value; }
        }
        ...
        protected override void WndProc(ref System.Windows.Forms.Message m)
        {
            ...
            if (m.Msg == WM_PAINT && this.Text.Length == 0 && !this.GetStyle(ControlStyles.UserPaint))
                DrawTextPrompt();
        }
