...
namespace UploadersLib.FileUploaders
{
    ...
    {
        internal const string SENDSPACE_API_KEY = "LV6OS1R0Q3";
        internal const string SENDSPACE_API_URL = "http://api.sendspace.com/rest/";
        internal const string SENDSPACE_API_VERSION = "1.0";
        ...
        public static SendSpaceHelper.UploadInfo UploadInfo;

        public static bool PrepareUploadInfo(string username, string password)
        {
            SendSpaceHelper sendSpace = new SendSpaceHelper();
