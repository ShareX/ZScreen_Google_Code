...
namespace HelpersLib
{
    public static class NativeMethods
    {
        ...
        {
            IntPtr iconHandle = SendMessage(hwnd, (int)WM.GETICON, ICON_SMALL2, 0);

            if (iconHandle == IntPtr.Zero)
                iconHandle = SendMessage(hwnd, (int)WM.GETICON, ICON_SMALL, 0);

            if (iconHandle == IntPtr.Zero)
                iconHandle = SendMessage(hwnd, (int)WM.GETICON, ICON_BIG, 0);
