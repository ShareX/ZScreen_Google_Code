...
{
    public class ScreenshotEffectsHelper
    {
        #region 0 Properties
        ...
        protected ScreenshotEffectsHelper() { }

        public ScreenshotEffectsHelper(ImageEffectsConfig cfg)
        {
            this.Config = cfg;
        }
        ...
        public Image ApplySizeChanges(Image img)
        {
            switch (Config.ImageSizeType)
            {
                case ImageSizeType.FIXED:
                    img = HelpersLib.GraphicsHelper.Core.ChangeImageSize(img, Config.ImageSizeFixedWidth, Config.ImageSizeFixedHeight, true, true);
                    break;
                case ImageSizeType.RATIO:
                    img = HelpersLib.GraphicsHelper.Core.ChangeImageSize(img, Config.ImageSizeRatioPercentage);
                    break;
            }
            return img;
        }
