...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public partial class ShellProperties
    {
        ...
        public class PropertySystem : PropertyStoreItems
        {
            ...
            /// </summary>
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", Justification="This is following the native API")]
            ...
            /// <para>Description: The list of type of items, this item contains. For example, this item contains urls, attachments etc.</para>
            ...
            /// <para>Description: The time the file entered the system via acquisition.  This is not the same as System.DateImported.</para>
            /// <para>Type:     DateTime -- VT_FILETIME  (For variants: VT_DATE)</para>
            ...
            /// <para>Description: This is the file extension of the file based item, including the leading period.  </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the unique file ID, also known as the File Reference Number. For a given file, this is the same value</para>
            /// <para>Type:     UInt64 -- VT_UI8</para>
            ...
            /// <para>Description: This is the file name (including extension) of the file.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.FlagColor.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.FlagStatus.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This PKEY is used to specify search terms that should be applied as broadly as possible,</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Importance.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// </summary>
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly", Justification = "This is following the native API")]
            ...
            /// <para>Description: This is the generic list of authors associated with an item. </para>
            /// <para>Type:     Multivalue String -- VT_VECTOR | VT_LPWSTR  (For variants: VT_ARRAY | VT_BSTR)</para>
            ...
            /// <para>Description: This is the main date for an item. The date of interest. </para>
            /// <para>Type:     DateTime -- VT_FILETIME  (For variants: VT_DATE)</para>
            ...
            /// <para>Description: This is the user-friendly display name of the parent folder of an item.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly display path of the parent folder of an item.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly display path of the parent folder of an item.  The format of the string</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the base-name of the System.ItemNameDisplay.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the display name in "most complete" form.  This is the best effort unique representation</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the prefix of an item, used for email messages.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the generic list of people associated with an item and who contributed </para>
            /// <para>Type:     Multivalue String -- VT_VECTOR | VT_LPWSTR  (For variants: VT_ARRAY | VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly display path to the item.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly display path to the item. The format of the string should be </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the canonical type of the item and is intended to be programmatically</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user friendly type name of the item.  This is not intended to be</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This always represents a well formed URL that points to the item.  </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: System.Kind is used to map extensions to various .Search folders.</para>
            /// <para>Type:     Multivalue String -- VT_VECTOR | VT_LPWSTR  (For variants: VT_ARRAY | VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Kind.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The shell namespace name of an item relative to a parent folder.  This name may be passed to </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the shell namespace path to the item.  This path may be passed to </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Priority.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: Indicates the users preference rating of an item on a scale of 1-99 (1-12 = One Star, </para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Rating.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Sensitivity.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: Indicates the users preference rating of an item on a scale of 0-5 (0=unrated, 1=One Star, 2=Two Stars, 3=Three Stars,</para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
            ...
            /// <para>Description: Unique value that can be used as a key to cache thumbnails. The value changes when the name, volume, or data modified </para>
            /// <para>Type:     UInt64 -- VT_UI8</para>
            ...
            /// 
            /// </summary>
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "GPS", Scope = "type", Target = "Microsoft.WindowsAPICodePack.Shell.ShellProperties+PropertySystemGPS", Justification="This is following the native API")]
        ...
        public class PropertySystemAppUserModel : PropertyStoreItems
        {
            ...
            /// </summary>
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", Justification = "This is following the native API")]
        ...
        public class PropertySystemCalendar : PropertyStoreItems
        {
            ...
            /// <para>Description: This is the user-friendly form of System.Calendar.ShowTimeAs.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        public class PropertySystemCommunication : PropertyStoreItems
        {
            ...
            /// <para>Description: This is the user-friendly form of System.Communication.TaskStatus.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        /// 
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", Justification = "It's the native name", MessageId = "PropertySystemGPS", Target = "Microsoft.WindowsAPICodePack.Shell.PropertySystemGPS.*", Scope="member")]
        public class PropertySystemGPS : PropertyStoreItems
        {
            ...
            /// <para>Description: Indicates the altitude based on the reference in PKEY_GPS_AltitudeRef.  Calculated from PKEY_GPS_AltitudeNumerator and </para>
            ...
            /// <para>Description: Indicates the bearing to the destination point.  Calculated from PKEY_GPS_DestBearingNumerator and </para>
            /// <para>Type:     Double -- VT_R8</para>
            ...
            /// <para>Description: Indicates the distance to the destination point.  Calculated from PKEY_GPS_DestDistanceNumerator and </para>
            /// <para>Type:     Double -- VT_R8</para>
            ...
            /// <para>Description: Indicates the latitude of the destination point.  This is an array of three values.  Index 0 is the degrees, index 1 </para>
            ...
            /// <para>Description: Indicates direction of the image when it was captured.  Calculated from PKEY_GPS_ImgDirectionNumerator and </para>
            /// <para>Type:     Double -- VT_R8</para>
            ...
            /// <para>Description: Indicates the latitude.  This is an array of three values.  Index 0 is the degrees, index 1 is the minutes, index 2 </para>
            /// <para>Type:     Multivalue Double -- VT_VECTOR | VT_R8  (For variants: VT_ARRAY | VT_R8)</para>
            ...
            /// <para>Description: Indicates the longitude.  This is an array of three values.  Index 0 is the degrees, index 1 is the minutes, index 2 </para>
            /// <para>Type:     Multivalue Double -- VT_VECTOR | VT_R8  (For variants: VT_ARRAY | VT_R8)</para>
            ...
            /// <para>Description: Indicates the speed of the GPS receiver movement.  Calculated from PKEY_GPS_SpeedNumerator and </para>
            /// <para>Type:     Double -- VT_R8</para>
            ...
            /// <para>Description: Indicates the unit used to express the speed of the GPS receiver movement.  (eg: kilometers per hour, </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: Indicates the status of the GPS receiver when the image was recorded.  (eg: measurement in progress, </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: Indicates the direction of the GPS receiver movement.  Calculated from PKEY_GPS_TrackNumerator and </para>
            /// <para>Type:     Double -- VT_R8</para>
        ...
        public class PropertySystemImage : PropertyStoreItems
        {
            ...
            /// <para>Description: This is the user-friendly form of System.Image.Compression.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        public class PropertySystemLayoutPattern : PropertyStoreItems
        {
            ...
            /// <para>Description: Specifies the layout pattern that the content view mode should apply for this item in the context of browsing.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: Specifies the layout pattern that the content view mode should apply for this item in the context of searching.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        public class PropertySystemLink : PropertyStoreItems
        {
            ...
            /// <para>Description: This is the shell namespace path to the target of the link item.  This path may be passed to </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: IShellFolder::GetAttributesOf flags for the target of a link, with SFGAO_PKEYSFGAOMASK </para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
            ...
            /// <para>Description: Expresses the SFGAO flags of a link as string values and is used as a query optimization.  See </para>
            /// <para>Type:     Multivalue String -- VT_VECTOR | VT_LPWSTR  (For variants: VT_ARRAY | VT_BSTR)</para>
        ...
        public class PropertySystemMessage : PropertyStoreItems
        {
            ...
            /// <para>Description: These are flags associated with email messages to know if a read receipt is pending, etc.</para>
            /// <para>Type:     Int32 -- VT_I4</para>
        ...
        public class PropertySystemMusic : PropertyStoreItems
        {
            ...
            /// <para>Description: Concatenation of System.Music.AlbumArtist and System.Music.AlbumTitle, suitable for indexing and display.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This property returns the best representation of Album Artist for a given music file</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        public class PropertySystemNote : PropertyStoreItems
        {
            ...
            /// <para>Description: This is the user-friendly form of System.Note.Color.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        public class PropertySystemPhoto : PropertyStoreItems
        {
            ...
            /// <para>Description: This is the brightness of the photo.</para>
            /// <para>Type:     Double -- VT_R8</para>
            ...
            /// <para>Description: This indicates the direction of contrast processing applied by the camera </para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.Contrast.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.ExposureProgram.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.Flash.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: PropertyTagExifFocalXRes.  Calculated from PKEY_Photo_FocalPlaneXResolutionNumerator and </para>
            /// <para>Type:     Double -- VT_R8</para>
            ...
            /// <para>Description: PropertyTagExifFocalYRes.  Calculated from PKEY_Photo_FocalPlaneYResolutionNumerator and </para>
            /// <para>Type:     Double -- VT_R8</para>
            ...
            /// <para>Description: This indicates the degree of overall image gain adjustment.</para>
            /// <para>Type:     Double -- VT_R8</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.GainControl.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.MeteringMode.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.Orientation.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the pixel composition. In JPEG compressed data, a JPEG marker is used </para>
            /// <para>Type:     UInt16 -- VT_UI2</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.PhotometricInterpretation.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the class of the program used by the camera to set exposure when the </para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.ProgramMode.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This indicates the direction of saturation processing applied by the camera when </para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.Saturation.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This indicates the direction of sharpness processing applied by the camera when </para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.Sharpness.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: This is the user-friendly form of System.Photo.WhiteBalance.  Not intended to be parsed </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        public class PropertySystemPropList : PropertyStoreItems
        {
            ...
            /// <para>Description: The list of properties to show in the file operation conflict resolution dialog. Properties with empty </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The list of properties to show in the content view mode of an item in the context of browsing.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The list of properties to show in the content view mode of an item in the context of searching.</para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The list of properties to show in the listview on extended tiles. Register under the regvalue of </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The list of properties to show in the file operation confirmation dialog. Properties with empty values </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The list of all the properties to show in the details page.  Property groups can be included in this list </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The list of properties to show in the infotip. Properties with empty values will not be displayed. Register </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The list of properties that are considered 'non-personal'. When told to remove all non-personal properties </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The one or two properties to display in the preview pane title section.  The optional second property is </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The list of properties to show in the infotip when the item is on a slow network. Properties with empty </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        public class PropertySystemSearch : PropertyStoreItems
        {
            ...
            /// <para>Description: The contents of the item. This property is for query restrictions only; it cannot be retrieved in a </para>
            /// <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
            ...
            /// <para>Description: The entry ID for an item within a given catalog in the Windows Search Index.</para>
            /// <para>Type:     Int32 -- VT_I4</para>
            ...
            /// <para>Description: When using CONTAINS over the Windows Search Index, this is the number of matches of the term.</para>
            /// <para>Type:     Int32 -- VT_I4</para>
        ...
        public class PropertySystemVideo : PropertyStoreItems
        {
            ...
            /// <para>Description: Indicates the horizontal portion of the aspect ratio. The X portion of XX:YY,</para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
            ...
            /// <para>Description: Indicates the vertical portion of the aspect ratio. The Y portion of </para>
            /// <para>Type:     UInt32 -- VT_UI4</para>
